...
const run=spawnSync(process.execPath,['--import',resolve(studio,'node_modules/tsx/dist/loader.mjs'),resolve(studio,'scripts/check-humanoid.ts'),resolve(model),resolve(out),...(option('--style')?[resolve(option('--style'))]:[])],{cwd:resolve(studio),stdio:'inherit'});
