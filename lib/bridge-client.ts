import type {GenerationRequest,HumanoidArtifact} from './generation';
export const BRIDGE_ORIGIN='http://127.0.0.1:43117';
const SESSION_KEY='dotforge.codex.session.v1';
export type BridgeJob={id:string;state:'running'|'ready'|'failed'|'cancelled';progress:number;error?:string;artifact?:HumanoidArtifact};
